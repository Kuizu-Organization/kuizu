...
public class ModerationService {
    ...
    private ModerationHistoryResponse mapToModerationHistoryResponse(ModerationHistory history) {
        ...
        private void logModerationAction(User moderator, String entityType, String entityId, String action,
                        String notes) {
                ModerationHistory history = ModerationHistory.builder()
                                .moderator(moderator)
                                .entityType(entityType)
        ...
        private ModerationHistoryResponse mapToModerationHistoryResponse(ModerationHistory history) {
                ...
                return ModerationHistoryResponse.builder()
                                ...
                                .moderatorUsername(history.getModerator() != null ? history.getModerator().getUsername()
                                                : null)
                                .moderatorDisplayName(
                                                history.getModerator() != null ? history.getModerator().getDisplayName()
                                                                : null)
